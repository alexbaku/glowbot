...
class ClaudeService:
    ...
    def _update_context_from_response(self, context: ConversationContext, response: InterviewMessage) -> None:
    ...
    async def get_response(self, user_id: str, user_input: str) -> str:
                ...
                try:
                    ...
                    full_system_prompt = self.base_system_prompt + self._get_state_specific_prompt(context.state)
        ...
        """
                    ...
                    logger.info(f"User: {user_id} | State: {context.state} | Action: {resp.action}")
